...
<body>
	...
	<div style="margin:20px">
		...
		&nbsp;&nbsp;&nbsp;
		<a href="Article_myComment.do"><span style="color: blue; ">我评论的帖子</span></a>
	</div>
	...
	<div class="container" style="margin-top: 20px;">
		<table class="table text-center table-bordered">
            ...
            <c:choose>
			  	...
			  	<c:otherwise>
			  		<li>
				    	<a class="page-link" href="${pageContext.request.contextPath }/Article_myComment.do?currentPage=${page.currentPage-1 }">&larr;上一页</a>
				    </li>
				</c:otherwise>
			  	</c:choose>
			   ...
			   <c:choose>
			  	...
			  	<c:otherwise>
			  		<li class="page-item">
				    	<a class="page-link" href="${pageContext.request.contextPath }/Article_myComment.do?currentPage=${page.currentPage+1 }">下一页&rarr;</a>
				    </li>
				</c:otherwise>
			  	</c:choose>
          </ul>
